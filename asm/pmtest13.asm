...
_priority			dd  500, 200, 100, 300			; 任务优先级

_time 				dd  500, 200, 100, 300			; 任务还能执行的时间片
...
ClockHandler	equ	_ClockHandler - $$
	...
	mov 	[dwNum], eax				; 这句忘加了，我通过打印eax到gs查看dwNum，发现的
	xor 	ecx, ecx					; max
	xor 	eax, eax
	xor 	ebx, ebx
.loop:
	mov 	edx, dword [time + eax * 4]
	cmp 	edx, ecx
	jle 	.label
	mov 	ecx, edx
	mov 	ebx, eax					; idx
